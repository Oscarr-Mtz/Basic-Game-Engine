...
def projectX(x, z):
    ...
    x1 = (x*d)/(d+z)
    return (((pixWidth/2)+(x1*pixWidth)/screenWidth))

def projectY(y, z):
    ''' maps y to screen y location '''
    y1 = (y*d)/(d+z)
    return (((pixHeight/2)+(y1*pixHeight)/screenHeight))
...
def main():
    ...
    points = [(-1, 1, 5), (-1, 1, 7), (-1, -1, 7), (1, 1, 7), (1, -1, 7), (1, -1, 5), (1, 1, 5),  (-1, -1, 5)]
    ...
    # create the polygons
    polygons = [(points[0], points[1], points[2], points[7]), 
                (points[7], points[2], points[4], points[5]),
                (points[5], points[4], points[3], points[6]),
                (points[6], points[3], points[1], points[0]),
                (points[3], points[4], points[2], points[1]),
                (points[5], points[6], points[0], points[7])]
